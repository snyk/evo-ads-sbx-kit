...
```
snyk-ads-next/files/home/corp-ca/zscaler-root-ca.crt   →   /home/agent/corp-ca/zscaler-root-ca.crt
```
...
security find-certificate -a -c "Zscaler Root CA" -p \
  ...
  > snyk-ads-next/files/home/corp-ca/zscaler-root-ca.crt
```
...
```bash
head -1 snyk-ads-next/files/home/corp-ca/*.crt        # must be BEGIN CERTIFICATE
openssl x509 -in snyk-ads-next/files/home/corp-ca/your-ca.crt -noout -text \
...
```bash
git add -f snyk-ads-next/files/home/corp-ca/zscaler-root-ca.crt
```
